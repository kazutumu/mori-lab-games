...
export default function Forest() {
  ...
  return <main className="forest-page">
    ...
    <footer className="forest-tools"><p>ドラッグで回転 · ピンチで拡大 · 木をタップ</p><div>
      <button onClick={() => api.current?.touch()}>木に触れる</button>
      <button aria-pressed={evening} onClick={() => { setEvening(!evening); api.current?.light(!evening); }}>{evening ? '朝の光へ' : '夕暮れへ'}</button>
